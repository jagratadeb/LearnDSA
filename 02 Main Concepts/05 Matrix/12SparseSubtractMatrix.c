...
void subtractSparseMatrices(int mat1[][3], int size1, int mat2[][3], int size2, int result[][3], int *sizeResult)
{
    int i = 0, j = 0, k = 0;
...
int main()
{
    ...
    subtractSparseMatrices(mat1, size1, mat2, size2, result, &sizeResult);
